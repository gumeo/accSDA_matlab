...
display('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
TSMW = tic;
[B, ~, best_ind] = SDADcv(train, folds, Om, gam, lams, mu, q, PGsteps, Pt, maxits, tol, feat, quiet);
T3 =toc(TSMW);
...
gams = zeros(13, q);
for i = 1:q
    tmp = linspace(0,1, 13)*max_gamma(i);
    gams(:,i) = sort(tmp', 'descend');
...
display('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
TSZVD = tic;
[B4, best_ind] = SZVDcv(train, folds, gams, beta, D, q, maxits, Pt, ztol, feat, 0);
T4 =toc(TSZVD);
...
feat = 0.15;
feats = -linspace(0.05,1.25,13)*q*p*feat;
...
display('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
TSDA = tic;
[B, Q] = SDAcv(train, folds, gam, feats, q, maxits, tol, 1); 
T5 =toc(TSDA);
